...
import loginService, {type userWithToken} from '../services/login'
...
const LoginPage = () => {
  ...
  const [currentUser, setCurrentUser] = useState< userWithToken | null>(null)

  useEffect(() => {
    const loggedUserJSON = localStorage.getItem('loggedBookappUser') 
    if (loggedUserJSON) {
