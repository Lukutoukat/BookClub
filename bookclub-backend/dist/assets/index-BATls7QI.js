...
function pt(e, t, n) {
  ...
  function d(e, n, i) {
    ...
    if (j.isReactNative(t) && j.isReactNativeBlob(e))
      return (t.append(ut(i, n, a), u(e)), !1);
      ...
      let n = new AbortController(),
        ...
        i = function (e) {
          if (!r) {
            ...
            n.abort(
              t instanceof M ? t : new Lt(t instanceof Error ? t.message : t),
            );
          }
        },
        a =
...
var un = `1.16.0`,
  ...
  mn = (e) => {
    ...
    let h = async (e) => {
        ...
        if (j.isSpecCompliantForm(e))
          return (
            await new a(N.origin, { method: `POST`, body: e }).arrayBuffer()
          ).byteLength;
  ...
  gn = (e) => {
    ...
    for (; o--; )
      ((s = a[o]),
        (c = l.get(s)),
        c === void 0 && l.set(s, (c = o ? new Map() : mn(t))),
        (l = c));
    return c;
  };
gn();
...
function bn(e, t) {
  ...
  for (let o = 0; o < n; o++) {
    ...
    if (
      ((i = r),
      !yn(r) && ((i = _n[(n = String(r)).toLowerCase()]), i === void 0))
    )
...
` + n);
    ...
    getUri(e) {
      return (
        ...
        vt(
          Yt(e.baseURL, e.url, e.allowAbsoluteUrls),
          e.params,
          e.paramsSerializer,
        )
      );
...
(j.forEach([`delete`, `get`, `head`, `options`], function (e) {
  kn.prototype[e] = function (t, n) {
    return this.request(
      Zt(n || {}, { method: e, url: t, data: (n || {}).data }),
    );
  };
}),
  j.forEach([`post`, `put`, `patch`, `query`], function (e) {
    ...
    ((kn.prototype[e] = t()),
      e !== `query` && (kn.prototype[e + `Form`] = t(!0)));
  }));
var An = class e {
  constructor(e) {
