...
` +
		...
		var Tn = {
			...
			Fn = wn(h({}, Tn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 })),
			In = wn(
				h({}, Tn, {
		...
		function gi(e, t, n, r, i, o) {
			...
			if (((r = e), typeof e == `function`)) pi(e) && (s = 1);
				...
				a: switch (e) {
					case te:
						return ((e = fi(31, n, t, i)), (e.elementType = te), (e.lanes = o), e);
					case y:
					...
					case b:
						...
						break;
					case x:
						return ((e = fi(12, n, t, i | 2)), (e.elementType = x), (e.lanes = o), e);
					case T:
						return ((e = fi(13, n, t, i)), (e.elementType = T), (e.lanes = o), e);
					case ee:
						return ((e = fi(19, n, t, i)), (e.elementType = ee), (e.lanes = o), e);
					default:
		...
		function za(e) {
			...
			function l(e, t, n, r) {
				...
				return a === y
					...
					: t !== null &&
						  (t.elementType === a ||
								(typeof a == `object` && a && a.$$typeof === D && Aa(a) === t.type))
						? ((t = i(t, n.props)), La(t, n), (t.return = e), t)
						: ((t = gi(n.type, n.key, n.props, null, e.mode, r)), La(t, n), (t.return = e), t);
			}
			function u(e, t, n, r) {
				return t === null ||
					t.tag !== 4 ||
			...
			function f(e, t, n) {
				...
				if (typeof t == `object` && t) {
					...
					if (se(t) || ie(t)) return ((t = _i(t, e.mode, n, null)), (t.return = e), t);
					...
					switch (o.$$typeof) {
						case _:
							a: {
								for (var l = o.key; r !== null; ) {
									if (r.key === l) {
										if (((l = o.type), l === y)) {
											...
											r.elementType === l ||
											(typeof l == `object` && l && l.$$typeof === D && Aa(l) === r.type)
										) {
								...
								o.type === y
									? ((c = _i(o.props.children, e.mode, c, o.key)), (c.return = e), (e = c))
		...
		function To(e) {
			...
			if (((mo = 0), (ho = B = z = null), (go = !1), (bo = 0), (xo = null), t)) throw Error(a(300));
		...
		function No(e) {
			...
			return (
				...
				(ho === null ? t.memoizedState : ho.next) === null &&
					((t = t.alternate), (O.H = t === null || t.memoizedState === null ? Bs : Vs)),
				e
			);
		}
		function Po(e) {
		...
		function nc(e, t, n, r, i) {
			...
			if (((o = Si(o, n)), Xl === null ? (Xl = [o]) : Xl.push(o), X !== 4 && (X = 2), t === null))
				return !0;
			((r = Si(r, n)), (n = t));
			do {
				switch (n.tag) {
		...
		function sc(e, t, n, r, i) {
			if (e === null) {
				var a = n.type;
				return typeof a == `function` && !pi(a) && a.defaultProps === void 0 && n.compare === null
		...
		function vc(e, t, n, r, i) {
			if ((ra(t), t.stateNode === null)) {
				...
				o !== d || f !== p || Ha || (e !== null && e.dependencies !== null && na(e.dependencies))
		...
		function Cc(e, t, n) {
			var r = t.pendingProps,
				...
				s;
			if (
				((s = o) || (s = e !== null && e.memoizedState === null ? !1 : (R.current & 2) != 0),
				s && ((i = !0), (t.flags &= -129)),
				(s = (t.flags & 32) != 0),
				(t.flags &= -33),
				e === null)
			...
			return i
				? (uo(t),
					...
					u === null ? ((c = _i(c, i, n, null)), (c.flags |= 2)) : (c = mi(u, c)),
					(c.return = t),
					(r.return = t),
					(r.sibling = c),
					(t.child = r),
					...
					c === null
						...
						: ((i = c.cachePool),
							i === null
								? (i = Ca())
								: ((l = L._currentValue), (i = i.parent === l ? i : { parent: l, pool: l })),
		...
		function Mc(e, t, n) {
			switch (t.tag) {
				...
				case 19:
					var i = (e.flags & 128) != 0;
					if (
						((r = (n & t.childLanes) !== 0), (r ||= (ta(e, t, n, !1), (n & t.childLanes) !== 0)), i)
					) {
		...
		function Nc(e, t, n) {
			...
			switch (((t.lanes = 0), t.tag)) {
					...
					return (
						e === null &&
							...
							((i = r = F) &&
								...
								r === null
									? (i = !1)
									: ((t.stateNode = r), (Li = t), (F = cf(r.firstChild)), (zi = !1), (i = !0))),
							i || Vi(t)),
						ye(t),
						(i = t.type),
						(o = t.pendingProps),
					...
					return (
						e === null &&
							...
							((e = n = F) &&
								...
								n === null ? (e = !1) : ((t.stateNode = n), (Li = t), (F = null), (e = !0))),
							e || Vi(t)),
						null
					);
				case 13:
				...
				case 12:
					return (ac(e, t, t.pendingProps.children, n), t.child);
				case 10:
					return ((r = t.pendingProps), Zi(t, t.type, r.value), ac(e, t, r.children, n), t.child);
				case 9:
					return (
						(i = t.type._context),
					...
					return (
						...
						e === null
							...
							: ((e.lanes & n) !== 0 && (Wa(e, t), Za(t, null, null, n), Xa()),
								...
								(o = t.memoizedState),
								i.parent === r
									? ((r = o.cache), Zi(t, L, r), r !== i.cache && ea(t, [L], n, !0))
									: ((i = { parent: r, cache: r }),
										(t.memoizedState = i),
				...
				if (!(t & 7)) {
					a: {
						if (
							...
							s && n !== on && (u = n.relatedTarget || n.fromElement) && (xt(u) || u[mt]))
						)
							break a;
						if (
							(c || s) &&
							...
							if (
								...
								(e === `pointerout` || e === `pointerover`) &&
									((d = Wn), (g = `onPointerLeave`), (p = `onPointerEnter`), (m = `pointer`)),
								(f = c == null ? s : Ct(c)),
								(h = u == null ? s : Ct(u)),
					...
					(x &&
						($n &&
							...
							(ir || x !== `onCompositionStart`
								...
								: ((_n = i), (vn = `value` in _n ? _n.value : _n.textContent), (ir = !0))),
						(y = Ed(r, x)),
						0 < y.length &&
	...
	We = ((e, t) =>
		e
			...
			: t
				...
				: (e) => setTimeout(e))(typeof setImmediate == `function`, T(ye.postMessage)),
	j = {
		isArray: y,
		isArrayBuffer: S,
		isBuffer: x,
...
function Ze(e) {
	return Ye(e.replace(Je, ``));
}
function Qe(e) {
	return e === !1 || e == null ? e : j.isArray(e) ? e.map(Qe) : Ze(String(e));
}
function $e(e) {
...
var it = class {
	...
	has(e, t) {
		if (((e = Xe(e)), e)) {
			let n = j.findKey(this, e);
			return !!(n && this[n] !== void 0 && (!t || tt(this, this[n], n, t)));
		}
		return !1;
	}
	delete(e, t) {
		...
		function i(e) {
			if (((e = Xe(e)), e)) {
				let i = j.findKey(n, e);
				i && (!t || tt(n, n[i], i, t)) && (delete n[i], (r = !0));
			}
		}
	...
	clear(e) {
		...
		for (; n--; ) {
			let i = t[n];
			(!e || tt(this, this[i], i, e, !0)) && (delete this[i], (r = !0));
		}
		return r;
	}
	normalize(e) {
...
`);
	...
	static accessor(e) {
		let t = (this[qe] = this[qe] = { accessors: {} }).accessors,
			n = this.prototype;
		function r(e) {
			let r = Xe(e);
			t[r] || (rt(n, e), (t[r] = !0));
...
function st(e, t) {
	let n = new Set(t.map((e) => String(e).toLowerCase())),
		...
		i = (e) => {
			...
			(e instanceof it && (e = e.toJSON()), r.push(e));
			let t;
			if (j.isArray(e))
				((t = []),
					e.forEach((e, n) => {
				...
				if (!j.isPlainObject(e) && ot(e)) return (r.pop(), e);
...
var M = class e extends Error {
	...
	toJSON() {
		let e = this.config,
			...
			n = j.isArray(t) && t.length > 0 ? st(e, t) : j.toJSONObject(e);
		return {
...
function dt(e) {
	return j.isArray(e) && !e.some(ct);
}
var ft = j.toFlatObject(j, {}, null, function (e) {
...
function pt(e, t, n) {
	...
	function u(e) {
		...
		if (!l && j.isBlob(e)) throw new M(`Blob is not supported. Use a Buffer instead.`);
	...
	function d(e, n, i) {
		let s = e;
		if (j.isReactNative(t) && j.isReactNativeBlob(e)) return (t.append(ut(i, n, a), u(e)), !1);
				...
				return (
					...
					s.forEach(function (e, r) {
						!(j.isUndefined(e) || e === null) &&
							t.append(o === !0 ? ut([n], r, a) : o === null ? n : n + `[]`, u(e));
					}),
					!1
				);
		}
...
function vt(e, t, n) {
	...
	let r = (n && n.encode) || _t,
		...
		a = i && i.serialize,
		o;
	if (((o = a ? a(t, i) : j.isURLSearchParams(t) ? t.toString() : new ht(t, i).toString(r)), o)) {
		let t = e.indexOf(`#`);
...
var yt = class {
	...
	Tt = Ct && (!wt || [`ReactNative`, `NativeScript`, `NS`].indexOf(wt.product) < 0),
	Et =
		typeof WorkerGlobalScope < `u` &&
		self instanceof WorkerGlobalScope &&
		typeof self.importScripts == `function`,
	Dt = (Ct && window.location.href) || `http://localhost`,
	N = { ...St, ...xt };
function Ot(e, t) {
	return pt(e, new N.classes.URLSearchParams(), {
		visitor: function (e, t, n, r) {
			return N.isNode && j.isBuffer(e)
		...
		return (
			...
			s
				...
				: ((!r[a] || !j.isObject(r[a])) && (r[a] = []),
					t(e, n, r[a], i) && j.isArray(r[a]) && (r[a] = At(r[a])),
					!o)
		);
	}
...
var Mt = (e, t) => (e != null && j.hasOwnProp(e, t) ? e[t] : void 0);
function Nt(e, t, n) {
	if (j.isString(e))
		try {
...
var Pt = {
	...
	transformResponse: [
		function (e) {
			let t = Mt(this, `transitional`) || Pt.transitional,
				n = t && t.forcedJSONParsing,
				r = Mt(this, `responseType`),
				i = r === `json`;
				...
				try {
					...
					if (n)
						throw e.name === `SyntaxError`
							? M.from(e, M.ERR_BAD_RESPONSE, this, null, Mt(this, `response`))
							: e;
				}
			}
			return e;
...
var en = (e) =>
	...
	tn = (e) => {
		...
		if (
			...
			(t.url = vt(Yt(l, d, u), e.params, e.paramsSerializer)),
			c &&
				s.set(
					`Authorization`,
					`Basic ` + btoa((c.username || ``) + `:` + (c.password ? en(c.password) : ``)),
				),
			j.isFormData(r) &&
				(N.hasStandardBrowserEnv || N.hasStandardBrowserWebWorkerEnv
					? s.setContentType(void 0)
					: j.isFunction(r.getHeaders) && $t(s, r.getHeaders(), n(`formDataHeaderPolicy`))),
			N.hasStandardBrowserEnv &&
				(j.isFunction(i) && (i = i(t)), i === !0 || (i == null && Gt(t.url))))
		) {
			let e = a && o && Kt.read(o);
			e && s.set(a, e);
		}
	...
	nn =
		...
		function (e) {
			return new Promise(function (t, n) {
				...
				function g() {
					if (!h) return;
					let r = it.from(`getAllResponseHeaders` in h && h.getAllResponseHeaders());
					(Rt(
						function (e) {
							(t(e), m());
						},
				...
				(`onloadend` in h
					...
					(h.onabort = function () {
						h &&= (n(new M(`Request aborted`, M.ECONNABORTED, e, h)), m(), null);
					}),
					(h.onerror = function (t) {
						let r = new M(t && t.message ? t.message : `Network Error`, M.ERR_NETWORK, e, h);
					...
					(h.ontimeout = function () {
						...
						(r.timeoutErrorMessage && (t = r.timeoutErrorMessage),
							n(new M(t, i.clarifyTimeoutError ? M.ETIMEDOUT : M.ECONNABORTED, e, h)),
							m(),
							(h = null));
					}),
					...
					c && (([d, p] = Ht(c, !0)), h.addEventListener(`progress`, d)),
					s &&
						h.upload &&
						(([u, f] = Ht(s)),
			...
			let n = new AbortController(),
				...
				i = function (e) {
					if (!r) {
						...
						n.abort(t instanceof M ? t : new Lt(t instanceof Error ? t.message : t));
					}
				},
				a =
					t &&
...
var un = `1.16.0`,
	...
	mn = (e) => {
		...
		let { fetch: i, Request: a, Response: o } = e,
			s = i ? fn(i) : typeof fetch == `function`,
			c = fn(a),
			l = fn(o);
		if (!s) return !1;
		let u = s && fn(n),
			...
			p = l && u && pn(() => j.isReadableStream(new o(``).body)),
			m = { stream: p && ((e) => e.body) };
		s &&
		...
		let h = async (e) => {
				...
				if (j.isSpecCompliantForm(e))
					return (await new a(N.origin, { method: `POST`, body: e }).arrayBuffer()).byteLength;
		...
		return async (e) => {
			...
			let E = rn([l, u && u.toAbortSignal()], d),
				D = null,
				te =
					E &&
					E.unsubscribe &&
				...
				ne;
			try {
				if (w && typeof t == `string` && t.startsWith(`data:`) && ln(t) > S)
					throw new M(`maxContentLength size of ` + S + ` exceeded`, M.ERR_BAD_RESPONSE, e, D);
				if (T && n !== `get` && n !== `head`) {
					let t = await g(y, s);
					if (typeof t == `number` && isFinite(t) && t > C)
						throw new M(`Request body larger than maxBodyLength limit`, M.ERR_BAD_REQUEST, e, D);
				}
				if (_ && f && n !== `get` && n !== `head` && (ne = await g(y, s)) !== 0) {
					let e = new a(t, { method: `POST`, body: s, duplex: `half` }),
						n;
					if (
						(j.isFormData(s) && (n = e.headers.get(`content-type`)) && y.setContentType(n), e.body)
					) {
						let [t, n] = Ut(ne, Ht(Wt(_)));
						s = cn(e.body, dn, t, n);
					}
				}
						...
						(re != null &&
							(typeof re.byteLength == `number`
								...
								: typeof re.size == `number`
									? (t = re.size)
									: typeof re == `string` &&
										(t = typeof r == `function` ? new r().encode(re).byteLength : re.length)),
						typeof t == `number` && t > S)
					)
						throw new M(`maxContentLength size of ` + S + ` exceeded`, M.ERR_BAD_RESPONSE, e, D);
				}
				...
				throw t && t.name === `TypeError` && /Load failed|fetch/i.test(t.message)
					? Object.assign(new M(`Network Error`, M.ERR_NETWORK, e, D, t && t.response), {
							cause: t.cause || t,
						})
	...
	gn = (e) => {
		let t = (e && e.env) || {},
			...
			l = hn;
		for (; o--; )
			((s = a[o]), (c = l.get(s)), c === void 0 && l.set(s, (c = o ? new Map() : mn(t))), (l = c));
		return c;
	};
gn();
var _n = { http: null, xhr: nn, fetch: { get: gn } };
j.forEach(_n, (e, t) => {
	if (e) {
		try {
...
var vn = (e) => `- ${e}`,
	yn = (e) => j.isFunction(e) || e === null || e === !1;
function bn(e, t) {
	e = j.isArray(e) ? e : [e];
	let { length: n } = e,
		r,
	...
	for (let o = 0; o < n; o++) {
		r = e[o];
		let n;
		if (((i = r), !yn(r) && ((i = _n[(n = String(r)).toLowerCase()]), i === void 0)))
...
var xn = { getAdapter: bn, adapters: _n };
function Sn(e) {
		...
		xn
			...
			.then(
				function (t) {
					...
					return ((t.headers = it.from(t.headers)), t);
				},
				function (t) {
					if (!It(t) && (Sn(e), t && t.response)) {
...
((wn.transitional = function (e, t, n) {
	...
	return (n, i, a) => {
		if (e === !1) throw new M(r(i, ` has been removed` + (t ? ` in ` + t : ``)), M.ERR_DEPRECATED);
		return (
			t &&
				!Tn[i] &&
				((Tn[i] = !0),
...
function En(e, t, n) {
	...
	for (; i-- > 0; ) {
		...
		if (o) {
			let t = e[a],
				n = t === void 0 || o(t, a, e);
			if (n !== !0) throw new M(`option ` + a + ` must be ` + n, M.ERR_BAD_OPTION_VALUE);
			continue;
		}
...
var Dn = { assertOptions: En, validators: wn },
	...
	kn = class {
		constructor(e) {
			((this.defaults = e || {}), (this.interceptors = { request: new yt(), response: new yt() }));
		}
		async request(e, t) {
			try {
...
` + n);
			...
			(n !== void 0 &&
				...
				r != null &&
					(j.isFunction(r)
						...
						: Dn.assertOptions(r, { encode: On.function, serialize: On.function }, !0)),
		...
		getUri(e) {
			return (
				...
				vt(Yt(e.baseURL, e.url, e.allowAbsoluteUrls), e.params, e.paramsSerializer)
			);
		}
	};
(j.forEach([`delete`, `get`, `head`, `options`], function (e) {
	kn.prototype[e] = function (t, n) {
		return this.request(Zt(n || {}, { method: e, url: t, data: (n || {}).data }));
	};
}),
	j.forEach([`post`, `put`, `patch`, `query`], function (e) {
		...
		((kn.prototype[e] = t()), e !== `query` && (kn.prototype[e + `Form`] = t(!0)));
	}));
var An = class e {
	constructor(e) {
...
((P.Axios = kn),
	...
	(P.mergeConfig = Zt),
	(P.AxiosHeaders = it),
	(P.formToJSON = (e) => jt(j.isHTMLForm(e) ? new FormData(e) : e)),
	(P.getAdapter = xn.getAdapter),
	(P.HttpStatusCode = Nn),
	(P.default = P));
var Fn = t((e) => {
		var t = Symbol.for(`react.transitional.element`);
...
(0, Ln.createRoot)(document.getElementById(`root`)).render(
	(0, zn.jsx)(() => {
		...
		return (
			...
			(0, zn.jsxs)(`div`, {
				children: [
					(0, zn.jsx)(`h1`, { children: `books` }),
					(0, zn.jsx)(`ul`, {
						children: e.map((e) => (0, zn.jsx)(`li`, { children: e })),
					}),
					(0, zn.jsxs)(`form`, {
						onSubmit: (e) => {
							(e.preventDefault(), console.log(`button clicked`, e.target));
						},
						children: [
							(0, zn.jsx)(`input`, {}),
							(0, zn.jsx)(`button`, { type: `submit`, children: `save` }),
						],
					}),
				],
			})
