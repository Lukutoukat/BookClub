...
` +
    ...
    function ct(e, t) {
      var n = t & -t
      return ((n = n & 42 ? 1 : j(n)), (n & (e.suspendedLanes | t)) === 0 ? n : 0)
    }
    function j(e) {
      switch (e) {
        case 2:
    ...
    var En = {
      ...
      In = Tn(h({}, En, { animationName: 0, elapsedTime: 0, pseudoElement: 0 })),
      Ln = Tn(
        h({}, En, {
...
function Qe(e) {
  return Xe(e.replace(Ye, ``))
}
function $e(e) {
  return e === !1 || e == null ? e : A.isArray(e) ? e.map($e) : Qe(String(e))
}
function et(e) {
...
var at = class {
  ...
  set(e, t, n) {
    ...
    else if (A.isString(e) && (e = e.trim()) && !tt(e)) a(qe(e), t)
...
`)
  ...
  static accessor(e) {
    let t = (this[Je] = this[Je] = { accessors: {} }).accessors,
      n = this.prototype
    function r(e) {
      let r = Ze(e)
      t[r] || (it(n, e), (t[r] = !0))
...
;(at.accessor([
  ...
  A.reduceDescriptors(at.prototype, ({ value: e }, t) => {
...
function ct(e, t) {
  let n = new Set(t.map((e) => String(e).toLowerCase())),
    ...
    i = (e) => {
      ...
      ;(e instanceof at && (e = e.toJSON()), r.push(e))
      let t
      if (A.isArray(e))
        ((t = []),
          e.forEach((e, n) => {
        ...
        if (!A.isPlainObject(e) && st(e)) return (r.pop(), e)
...
var j = class e extends Error {
  ...
  toJSON() {
    let e = this.config,
      ...
      n = A.isArray(t) && t.length > 0 ? ct(e, t) : A.toJSONObject(e)
    return {
...
var pt = A.toFlatObject(A, {}, null, function (e) {
...
function mt(e, t, n) {
  ...
  function d(e, n, i) {
    let s = e
    if (A.isReactNative(t) && A.isReactNativeBlob(e)) return (t.append(dt(i, n, a), u(e)), !1)
        ...
        return (
          ...
          s.forEach(function (e, r) {
            !(A.isUndefined(e) || e === null) &&
              t.append(o === !0 ? dt([n], r, a) : o === null ? n : n + `[]`, u(e))
          }),
          !1
        )
    }
...
function yt(e, t, n) {
  ...
  let r = (n && n.encode) || vt,
    ...
    a = i && i.serialize,
    o
  if (((o = a ? a(t, i) : A.isURLSearchParams(t) ? t.toString() : new gt(t, i).toString(r)), o)) {
    let t = e.indexOf(`#`)
...
var bt = class {
  ...
  Et = wt && (!Tt || [`ReactNative`, `NativeScript`, `NS`].indexOf(Tt.product) < 0),
  Dt =
    typeof WorkerGlobalScope < `u` &&
    self instanceof WorkerGlobalScope &&
    typeof self.importScripts == `function`,
  Ot = (wt && window.location.href) || `http://localhost`,
  M = { ...Ct, ...St }
function kt(e, t) {
  return mt(e, new M.classes.URLSearchParams(), {
    ...
    return (
      ...
      s
        ...
        : ((!r[a] || !A.isObject(r[a])) && (r[a] = []),
          t(e, n, r[a], i) && A.isArray(r[a]) && (r[a] = jt(r[a])),
          !o)
    )
  }
...
var Nt = (e, t) => (e != null && A.hasOwnProp(e, t) ? e[t] : void 0)
function Pt(e, t, n) {
  if (A.isString(e))
    try {
        ...
        try {
          ...
          if (n)
            throw e.name === `SyntaxError`
              ? j.from(e, j.ERR_BAD_RESPONSE, this, null, Nt(this, `response`))
              : e
        }
      }
      return e
...
var Ut = (e, t, n = 3) => {
  ...
  Gt =
    ...
    (...t) =>
      A.asap(() => e(...t)),
  Kt = M.hasStandardBrowserEnv
    ? ((e, t) => (n) => (
        (n = new URL(n, M.origin)),
        e.protocol === n.protocol && e.host === n.host && (t || e.port === n.port)
      ))(new URL(M.origin), M.navigator && /(msie|trident)/i.test(M.navigator.userAgent))
    : () => !0,
  qt = M.hasStandardBrowserEnv
    ? {
        write(e, t, n, r, i, a, o) {
...
var tn = (e) =>
  ...
  nn = (e) => {
    let t = Qt({}, e),
      ...
      d = n(`url`)
    if (
      ((t.headers = s = at.from(s)),
      (t.url = yt(Xt(l, d, u), e.params, e.paramsSerializer)),
      c &&
        s.set(
          `Authorization`,
          `Basic ` + btoa((c.username || ``) + `:` + (c.password ? tn(c.password) : ``))
        ),
      A.isFormData(r) &&
        (M.hasStandardBrowserEnv || M.hasStandardBrowserWebWorkerEnv
          ? s.setContentType(void 0)
          : A.isFunction(r.getHeaders) && en(s, r.getHeaders(), n(`formDataHeaderPolicy`))),
      M.hasStandardBrowserEnv &&
        (A.isFunction(i) && (i = i(t)), i === !0 || (i == null && Kt(t.url))))
    ) {
      let e = a && o && qt.read(o)
      e && s.set(a, e)
    }
      ...
      let n = new AbortController(),
        ...
        i = function (e) {
          if (!r) {
            ...
            n.abort(t instanceof j ? t : new Rt(t instanceof Error ? t.message : t))
          }
        },
        a =
          t &&
...
var dn = `1.16.0`,
  ...
  hn = (e) => {
    ...
    let u = s && pn(n),
      ...
      p = l && u && mn(() => A.isReadableStream(new o(``).body)),
      m = { stream: p && ((e) => e.body) }
    s &&
    ...
    let h = async (e) => {
        ...
        if (A.isSpecCompliantForm(e))
          return (await new a(M.origin, { method: `POST`, body: e }).arrayBuffer()).byteLength
    ...
    return async (e) => {
      ...
      let te = an([l, u && u.toAbortSignal()], d),
        E = null,
        ne =
          te &&
          te.unsubscribe &&
  ...
  _n = (e) => {
    let t = (e && e.env) || {},
      ...
      l = gn
    for (; o--; )
      ((s = a[o]), (c = l.get(s)), c === void 0 && l.set(s, (c = o ? new Map() : hn(t))), (l = c))
    return c
  }
_n()
...
function xn(e, t) {
  ...
  for (let o = 0; o < n; o++) {
    r = e[o]
    let n
    if (((i = r), !bn(r) && ((i = vn[(n = String(r)).toLowerCase()]), i === void 0)))
  ...
  return (
    ...
    Sn.getAdapter(
      ...
      function (t) {
        ...
        return ((t.headers = at.from(t.headers)), t)
      },
      function (t) {
...
;((Tn.transitional = function (e, t, n) {
  function r(e, t) {
    return `[Axios v` + dn + `] Transitional option '` + e + `'` + t + (n ? `. ` + n : ``)
  }
  return (n, i, a) => {
...
var On = { assertOptions: Dn, validators: Tn },
  ...
  An = class {
    constructor(e) {
      ;((this.defaults = e || {}), (this.interceptors = { request: new bt(), response: new bt() }))
    }
    async request(e, t) {
      try {
...
` + n)
      ...
      ;(n !== void 0 &&
        ...
        r != null &&
          (A.isFunction(r)
            ...
            : On.assertOptions(r, { encode: kn.function, serialize: kn.function }, !0)),
    ...
    getUri(e) {
      return (
        ...
        yt(Xt(e.baseURL, e.url, e.allowAbsoluteUrls), e.params, e.paramsSerializer)
      )
    }
  }
;(A.forEach([`delete`, `get`, `head`, `options`], function (e) {
  An.prototype[e] = function (t, n) {
    return this.request(Qt(n || {}, { method: e, url: t, data: (n || {}).data }))
  }
}),
  A.forEach([`post`, `put`, `patch`, `query`], function (e) {
    ...
    ;((An.prototype[e] = t()), e !== `query` && (An.prototype[e + `Form`] = t(!0)))
  }))
var jn = class e {
  constructor(e) {
...
function Fn(e) {
  let t = new An(e),
    n = d(An.prototype.request, t)
  return (
    A.extend(n, An.prototype, t, { allOwnKeys: !0 }),
...
;((N.Axios = An),
  ...
  (N.mergeConfig = Qt),
  (N.AxiosHeaders = at),
  (N.formToJSON = (e) => Mt(A.isHTMLForm(e) ? new FormData(e) : e)),
...
;(0, Rn.createRoot)(document.getElementById(`root`)).render(
  (0, Bn.jsx)(() => {
    let [e, t] = (0, zn.useState)([])
    return (
      (0, zn.useEffect)(() => {
        N.get(Vn).then((n) => {
          ;(console.log(e), t(n.data))
        })
      }, []),
      (0, Bn.jsxs)(`div`, {
        children: [
          (0, Bn.jsx)(`h1`, { children: `boogs` }),
          (0, Bn.jsx)(`ul`, {
            children: e.map((e) => (0, Bn.jsx)(`li`, { children: e }))
          })
        ]
      })
    )
