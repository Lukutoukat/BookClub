...
function mt(e, t, n) {
  ...
  function d(e, n, i) {
    ...
    if (A.isReactNative(t) && A.isReactNativeBlob(e))
      return (t.append(dt(i, n, a), u(e)), !1);
      ...
      let n = new AbortController(),
        ...
        i = function (e) {
          if (!r) {
            ...
            n.abort(
              t instanceof j ? t : new Rt(t instanceof Error ? t.message : t),
            );
          }
        },
        a =
  ...
  hn = (e) => {
    ...
    let h = async (e) => {
        ...
        if (A.isSpecCompliantForm(e))
          return (
            await new a(M.origin, { method: `POST`, body: e }).arrayBuffer()
          ).byteLength;
